...
_G.packer_plugins = {
  ...
  ["inlay-hints.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/opt/inlay-hints.nvim",
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-treesitter-textobjects', 'vim-surround', 'nvim-treesitter-textsubjects', 'nvim-ts-context-commentstring', 'nvim-ts-rainbow'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
