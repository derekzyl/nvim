...
_G.packer_plugins = {
  ...
  ["inlay-hints.nvim"] = {
    ...
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/inlay-hints.nvim",
  ...
  neoterm = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/neoterm",
  ...
  ["nvim-treesitter-textsubjects"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/opt/nvim-treesitter-textsubjects",
  ...
  ["vim-doge"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/vim-doge",
  ...
  ["vim-grammarous"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/vim-grammarous",
    url = "https://github.com/rhysd/vim-grammarous"
  },
  ["vim-matchup"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/vim-matchup",
  ...
  ["vim-vinegar"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/vim-vinegar",
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-ts-context-commentstring', 'nvim-treesitter-textsubjects', 'nvim-treesitter-textobjects', 'nvim-ts-rainbow', 'vim-surround'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
