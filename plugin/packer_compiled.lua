...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'vim-surround', 'nvim-treesitter-textobjects', 'nvim-treesitter-textsubjects', 'nvim-ts-context-commentstring', 'nvim-ts-rainbow'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
